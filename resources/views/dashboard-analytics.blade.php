									...
									<tr>
										<td>
											<div class="d-flex align-items-center">
												...
												<div class="">
													<img src="{{ asset('assets/images/avatars/avatar-1.png') }}" class="rounded-circle" width="40" height="40" alt="">
												</div>
												<div class="ms-2">
									...
									<tr>
										<td>
											<div class="d-flex align-items-center">
												...
												<div class="">
													<img src="{{ asset('assets/images/avatars/avatar-2.png') }}" class="rounded-circle" width="40" height="40" alt="">
												</div>
												<div class="ms-2">
									...
									<tr>
										<td>
											<div class="d-flex align-items-center">
												...
												<div class="">
													<img src="{{ asset('assets/images/avatars/avatar-3.png') }}" class="rounded-circle" width="40" height="40" alt="">
												</div>
												<div class="ms-2">
									...
									<tr>
										<td>
											<div class="d-flex align-items-center">
												...
												<div class="">
													<img src="{{ asset('assets/images/avatars/avatar-4.png') }}" class="rounded-circle" width="40" height="40" alt="">
												</div>
												<div class="ms-2">
									...
									<tr>
										<td>
											<div class="d-flex align-items-center">
												...
												<div class="">
													<img src="{{ asset('assets/images/avatars/avatar-7.png') }}" class="rounded-circle" width="40" height="40" alt="">
												</div>
												<div class="ms-2">
									...
									<tr>
										<td>
											<div class="d-flex align-items-center">
												...
												<div class="">
													<img src="{{ asset('assets/images/avatars/avatar-8.png') }}" class="rounded-circle" width="40" height="40" alt="">
												</div>
												<div class="ms-2">
