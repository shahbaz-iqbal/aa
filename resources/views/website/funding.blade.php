	...
	<span class="mkdf-social-icon-widget   ion-social-pinterest   "></span> </a>
			...
			<div class="mkdf-content">
				<div class="mkdf-content-inner">
					<div class="mkdf-title-holder mkdf-centered-type mkdf-title-va-header-bottom mkdf-title-content-va-middle mkdf-preload-background mkdf-has-bg-image mkdf-bg-parallax" style="height: 430px;background-color: rgba(194,170,128,0.08);background-image:url(public/website/assets/wp-content/uploads/2018/03/Fundings-page.jpg);" data-height="430">
						<div class="mkdf-title-image">
							<img itemprop="image" src="<?php echo asset('public/website') ?>/assets/wp-content/uploads/2018/03/Fundings-page.jpg" alt="k" /><img itemprop="image" src="" alt="k" />
						</div>
						<div class="mkdf-title-wrapper" style="height: 430px">
							<div class="mkdf-title-inner">
								<div class="mkdf-grid">
									<h2 class="mkdf-page-title entry-title" style="color:white;">Funding</h2>
								</div>
							</div>
						</div>
					</div>

					<div class="mkdf-row-grid-section-wrapper mb-4" style="background-color:rgba(194,170,128,0.08)">
						<div class="mkdf-row-grid-section">
							<div class="vc_row wpb_row vc_row-fluid vc_custom_1522241979910">
								@if($funding)
								@foreach($funding as $funding_val)
								<div class="wpb_column vc_column_container vc_col-sm-12">
									<div class="vc_column-inner">
										<div class="wpb_wrapper" style="margin: 10px 0px;">
											<div class="wpb_text_column wpb_content_element ">
												<div class="wpb_wrapper">
													<h4>{{$funding_val->title}}</h4>
												</div>
											</div>
											<div class="wpb_text_column wpb_content_element ">
												<div class="wpb_wrapper">
													<p>
														{{$funding_val->description}}
													</p>
												</div>
											</div>
										</div>
