...
<body class="page-template page-template-full-width page-template-full-width-php page page-id-461 theme-anwalt anwalt-core-1.1.2 woocommerce-no-js anwalt-ver-1.4 mkdf-smooth-page-transitions mkdf-smooth-page-transitions-preloader mkdf-grid-1300 mkdf-sticky-header-on-scroll-down-up mkdf-dropdown-animate-height mkdf-header-standard mkdf-menu-area-shadow-disable mkdf-menu-area-in-grid-shadow-disable mkdf-menu-area-border-disable mkdf-menu-area-in-grid-border-disable mkdf-logo-area-border-disable mkdf-side-menu-slide-from-right mkdf-woocommerce-columns-3 mkdf-woo-normal-space mkdf-woo-pl-info-below-image mkdf-woo-single-thumb-below-image mkdf-woo-single-has-pretty-photo mkdf-default-mobile-header mkdf-sticky-up-mobile-header mkdf-header-top-enabled mkdf-search-covers-header wpb-js-composer js-comp-ver-6.4.1 vc_responsive" itemscope itemtype="http://schema.org/WebPage">
	...
	<section class="mkdf-side-menu">
		...
		<div id="media_image-5" class="widget mkdf-sidearea widget_media_image"><a href="#"><img width="289" height="25" src="<?php echo asset('/public/website') ?>/assets/wp-content/uploads/2018/03/side-area-img.png" class="image wp-image-1107  attachment-full size-full" alt="h" loading="lazy" style="max-width: 100%; height: auto;" /></a></div>
						...
						<div class="mkdf-full-width-inner">
							<div class="mkdf-grid-row">
								<div class="mkdf-page-content-holder mkdf-grid-col-12">
									...
									<div class="mkdf-title-holder mkdf-centered-type mkdf-title-va-header-bottom mkdf-title-content-va-middle mkdf-preload-background mkdf-has-bg-image mkdf-bg-parallax" style="height: 430px;background-color: rgba(194,170,128,0.08);background-image:url(assets/wp-content/uploads/2018/03/p-title-background-1.jpg);" data-height="430">
										...
										<div class="mkdf-title-wrapper" style="height: 430px">
											<div class="mkdf-title-inner">
												<div class="mkdf-grid">
													<h2 class="mkdf-page-title entry-title">Our Team</h2>
												</div>
											</div>
										</div>
									</div>
															...
															<div class="mkdf-section-title-holder  " style="text-align: center">
																<div class="mkdf-st-inner">
																	<h3 class="mkdf-st-title">
																		Experts in criminal law </h3>
																	<div class="mkdf-separator-holder clearfix  mkdf-separator-center mkdf-separator-normal">
																		<div class="mkdf-separator" style="width: 143px;border-bottom-width: 2px">
																		</div>
																	</div>
																	<h6 class="mkdf-st-text">
																		Professionals with exceptional legal background
																		and years of law expertise. </h6>
																</div>
															</div>
														</div>
													</div>
									...
									<div class="mkdf-row-grid-section-wrapper ">
										<div class="mkdf-row-grid-section">
											<div class="vc_row wpb_row vc_row-fluid vc_custom_1522052112290">
															...
															<div class="mkdf-team-holder mkdf-team-info-below-image">
																<div class="mkdf-team-inner">
																	...
																	<div class="mkdf-team-info">
																		...
																		<p class="mkdf-team-text">Lorem ipsum dolor sit
																		...
																		<div class="mkdf-team-social-holder">
																			<span class="mkdf-team-icon"> <span class="mkdf-icon-shortcode mkdf-normal    ">
																					...
																					<a class="" href="https://www.facebook.com/QodeInteractive/" target="_blank">
																						<i class="mkdf-icon-ion-icon ion-social-facebook mkdf-icon-element"></i>
																					</a>
																				</span>
																			</span>
																			<span class="mkdf-team-icon"> <span class="mkdf-icon-shortcode mkdf-normal    ">
																					...
																					<a class="" href="https://www.instagram.com/qodeinteractive/" target="_blank">
																						<i class="mkdf-icon-ion-icon ion-social-instagram mkdf-icon-element"></i>
																					</a>
																				</span>
																			</span>
																			<span class="mkdf-team-icon"> <span class="mkdf-icon-shortcode mkdf-normal    ">
																					...
																					<a class="" href="https://www.linkedin.com/company/qode-themes/" target="_blank">
																						<i class="mkdf-icon-ion-icon ion-social-linkedin mkdf-icon-element"></i>
																					</a>
																				</span>
																			</span>
																			<span class="mkdf-team-icon"> <span class="mkdf-icon-shortcode mkdf-normal    ">
																					...
																					<a class="" href="https://www.pinterest.com/qodeinteractive/" target="_blank">
																						<i class="mkdf-icon-ion-icon ion-social-pinterest mkdf-icon-element"></i>
																					</a>
																				</span>
																			</span>
																		</div>
															...
															<div class="mkdf-team-holder mkdf-team-info-below-image">
																<div class="mkdf-team-inner">
																	...
																	<div class="mkdf-team-info">
																		...
																		<p class="mkdf-team-text">Aliquam lorem ante,
															...
															<div class="mkdf-team-holder mkdf-team-info-below-image">
																<div class="mkdf-team-inner">
																	...
																	<div class="mkdf-team-info">
																		...
																		<p class="mkdf-team-text">Phasellus viverra
															...
															<div class="mkdf-team-holder mkdf-team-info-below-image">
																<div class="mkdf-team-inner">
																	...
																	<div class="mkdf-team-info">
																		...
																		<p class="mkdf-team-text">Donec quam felis,
																			ultricies nec, pellentesque eu, pretium sem.
																		</p>
																		<div class="mkdf-separator-holder clearfix  mkdf-separator-center ">
																			<div class="mkdf-separator" style="width: 100px"></div>
																		</div>
