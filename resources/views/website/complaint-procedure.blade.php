...
<title>Complaint Procedure</title>
...
<body class="page-template page-template-full-width page-template-full-width-php page page-id-461 theme-anwalt anwalt-core-1.1.2 woocommerce-no-js anwalt-ver-1.4 mkdf-smooth-page-transitions mkdf-smooth-page-transitions-preloader mkdf-grid-1300 mkdf-sticky-header-on-scroll-down-up mkdf-dropdown-animate-height mkdf-header-standard mkdf-menu-area-shadow-disable mkdf-menu-area-in-grid-shadow-disable mkdf-menu-area-border-disable mkdf-menu-area-in-grid-border-disable mkdf-logo-area-border-disable mkdf-side-menu-slide-from-right mkdf-woocommerce-columns-3 mkdf-woo-normal-space mkdf-woo-pl-info-below-image mkdf-woo-single-thumb-below-image mkdf-woo-single-has-pretty-photo mkdf-default-mobile-header mkdf-sticky-up-mobile-header mkdf-header-top-enabled mkdf-search-covers-header wpb-js-composer js-comp-ver-6.4.1 vc_responsive" itemscope itemtype="http://schema.org/WebPage">
	<!-- <div class="mkdf-smooth-transition-loader mkdf-mimic-ajax">
		<div class="mkdf-st-loader">
			<div class="mkdf-st-loader1">
				<div class="mkdf-reveal-image"><img src="assets/wp-content/uploads/2018/04/preloader-img.png" alt="spinner" />
	...
	<section class="mkdf-side-menu">
		...
		<div id="media_image-5" class="widget mkdf-sidearea widget_media_image"><a href="#"><img width="289" height="25" src="assets/wp-content/uploads/2018/03/side-area-img.png" class="image wp-image-1107  attachment-full size-full" alt="h" loading="lazy" style="max-width: 100%; height: auto;" /></a></div>
		...
		<div class="widget mkdf-social-icons-group-widget text-align-left"> <a class="mkdf-social-icon-widget-holder mkdf-icon-has-hover" data-hover-color="#6c5835" style="color: #ffffff;;font-size: 18px;margin: 0px 20px 0px 0px;" href="https://www.facebook.com/QodeInteractive/" target="_blank">
				<span class="mkdf-social-icon-widget ion-social-facebook"></span> </a>
			<a class="mkdf-social-icon-widget-holder mkdf-icon-has-hover" data-hover-color="#6c5835" style="color: #ffffff;;font-size: 18px;margin: 0px 20px 0px 0px;" href="https://www.instagram.com/qodeinteractive/" target="_blank">
				<span class="mkdf-social-icon-widget ion-social-instagram"></span> </a>
			<a class="mkdf-social-icon-widget-holder mkdf-icon-has-hover" data-hover-color="#6c5835" style="color: #ffffff;;font-size: 18px;margin: 0px 20px 0px 0px;" href="https://www.linkedin.com/company/qode-themes/" target="_blank">
				<span class="mkdf-social-icon-widget ion-social-linkedin"></span> </a>
			<a class="mkdf-social-icon-widget-holder mkdf-icon-has-hover" data-hover-color="#6c5835" style="color: #ffffff;;font-size: 18px;margin: 0px 20px 0px 0px;" href="https://www.pinterest.com/qodeinteractive/" target="_blank">
				<span class="mkdf-social-icon-widget ion-social-pinterest"></span> </a>
		</div>
		<div id="text-10" class="widget mkdf-sidearea widget_text">
			<div class="mkdf-widget-title-holder">
				<h5 class="mkdf-widget-title">London Office</h5>
			</div>
			<div class="textwidget">
				<p><a href="https://www.google.rs/maps/place/The+Nomad+Hotel/@40.7461394,-73.9883576,14.75z/data=!4m15!1m9!2m8!1z0KXQvtGC0LXQu9C4!3m6!1z0KXQvtGC0LXQu9C4!2z0IrRg9GY0L7RgNC6LCDQodGY0LXQtNC40ZrQtdC90LUg0JTRgNC20LDQstC1!3s0x89c24fa5d33f083b:0xc80b8f06e177fe62!4m2!1d-74.0059728!2d40.7127753!3m4!1s0x89c259a60a2beaf9:0xac8f81eb5975ef53!8m2!3d40.7449648!4d-73.9885479">1170
					...
					Email: <a href="../cdn-cgi/l/email-protection.html#47262930262b3307362823222e293322352624332e31226924282a"><span class="__cf_email__" data-cfemail="01606f76606d7541706e6564686f7564736062756877642f626e6c">[email&#160;protected]</span></a>
				</p>
			</div>
		</div>
		<div id="text-11" class="widget mkdf-sidearea widget_text">
			<div class="mkdf-widget-title-holder">
				<h5 class="mkdf-widget-title">Quick Contact</h5>
			</div>
			<div class="textwidget">
				<p><a href="https://www.google.rs/maps/place/The+Nomad+Hotel/@40.7461394,-73.9883576,14.75z/data=!4m15!1m9!2m8!1z0KXQvtGC0LXQu9C4!3m6!1z0KXQvtGC0LXQu9C4!2z0IrRg9GY0L7RgNC6LCDQodGY0LXQtNC40ZrQtdC90LUg0JTRgNC20LDQstC1!3s0x89c24fa5d33f083b:0xc80b8f06e177fe62!4m2!1d-74.0059728!2d40.7127753!3m4!1s0x89c259a60a2beaf9:0xac8f81eb5975ef53!8m2!3d40.7449648!4d-73.9885479">1170
						Broadway, New York, NY 10001</a><br />
						...
						<div class="mkdf-full-width-inner">
							<div class="mkdf-grid-row">
								<div class="mkdf-page-content-holder mkdf-grid-col-12">
													...
													<div class="wpb_revslider_element wpb_content_element">
														...
														<rs-module-wrap id="rev_slider_3_2_wrapper"
															...
															<rs-module id="rev_slider_3_2" style=""
																...
																<rs-slides>
																	<rs-slide data-key="rs-3" data-title="Slide"
																		...
																		<img src="assets/wp-content/uploads/2018/03/h2-slider1-background-img.jpg"
																		...
																		<rs-layer id="slider-3-slide-3-layer-4"
																			...
																			style="z-index:5;"><img
																				src="assets/wp-content/uploads/2018/03/h2-slider1-img-1.png"
																	...
																	<rs-slide data-key="rs-7" data-title="Slide"
																		...
																		data-anim="ei:d;eo:d;s:d;r:0;t:fade;sl:d;">
																		<img src="assets/wp-content/uploads/2018/03/h2-slider2-background-img.jpg"
																	...
																	<rs-slide data-key="rs-8" data-title="Slide"
																		...
																		data-anim="ei:d;eo:d;s:d;r:0;t:fade;sl:d;">
																		<img src="assets/wp-content/uploads/2018/03/h2-slider3-background-img.jpg"
															...
															<script type="text/javascript">
																setREVStartSize({ c: 'rev_slider_3_2', rl: [1920, 1720, 1025, 480], el: [], gw: [1300, 1100, 600, 300], gh: [680, 440, 550, 450], type: 'standard', justify: '', layout: 'fullwidth', mh: "0" });
																var revapi3,
																	tpj;
									...
									<div class="mkdf-title-holder mkdf-centered-type mkdf-title-va-header-bottom mkdf-title-content-va-middle mkdf-preload-background mkdf-has-bg-image mkdf-bg-parallax" style="height: 430px;background-color: rgba(194,170,128,0.08);background-image:url(public/website/assets/wp-content/uploads/2018/03/p-title-background-1.jpg);" data-height="430">
										...
										<div class="mkdf-title-wrapper" style="height: 430px">
											<div class="mkdf-title-inner">
												<div class="mkdf-grid">
													<h2 class="mkdf-page-title entry-title">Complaint Procedure</h2>
												</div>
											</div>
										</div>
									</div>
														...
														<div class="wpb_wrapper">
															<div class="mkdf-section-title-holder" style="text-align: center">
																<div class="mkdf-st-inner">
																	<h3 class="mkdf-st-title">Complaint Procedure</h3>
																	<div class="mkdf-separator-holder clearfix  mkdf-separator-center mkdf-separator-normal">
																		<div class="mkdf-separator" style="width: 143px;border-bottom-width: 2px"></div>
																	</div>
																	<p class="mkdf-st-text" style="text-align:justify; font-size: 17px;">
									...
									<div class="vc_row wpb_row vc_row-fluid call-us vc_custom_1522660415400 mkdf-content-aligment-center" style="background-color:#aa9166">
										<div class="wpb_column vc_column_container vc_col-sm-12">
											<div class="vc_column-inner">
												<div class="wpb_wrapper">
													<div class="wpb_text_column wpb_content_element">
														<div class="wpb_wrapper">
															<h4><span style="color: #ffffff;">Need a lawyer? We have the best </span> <a href="tel:+35123456789">+35 123 456 789</a></h4>
														</div>
													</div>
												</div>
											</div>
																		...
																		<div class="mkdf-eh-item-content mkdf-eh-custom-4196">
																			<div class="mkdf-single-image-holder">
																				<div class="mkdf-si-inner">
																					<img width="1024" height="654" src="<?php echo asset('/public/website/assets/wp-content/uploads/2018/03/h2-img-1.jpg') ?>" class="attachment-full size-full" alt="t" loading="lazy" srcset="<?php echo asset('/public/website/assets/wp-content/uploads/2018/03/h2-img-1.jpg') ?> 1024w, <?php echo asset('/public/website/assets/wp-content/uploads/2018/03/h2-img-1.jpg') ?> 300w, <?php echo asset('/public/website/assets/wp-content/uploads/2018/03/h2-img-1.jpg') ?> 768w, <?php echo asset('/public/website/assets/wp-content/uploads/2018/03/h2-img-1.jpg') ?> 800w" sizes="(max-width: 1024px) 100vw, 1024px" />
																				</div>
																			</div>
																		</div>
																	</div>
																		...
																		<div class="mkdf-eh-item-content mkdf-eh-custom-7072" style="padding: 0px 0px 0px 30px">
																			<div class="mkdf-accordion-holder mkdf-ac-default  mkdf-accordion mkdf-ac-boxed mkdf-white-skin clearfix">
																				...
																				<p class="mkdf-accordion-title">
																					...
																					<span class="mkdf-tab-title">Team of
																						law experts</span>
																				</p>
																				<div class="mkdf-accordion-content">
																					<div class="mkdf-accordion-content-inner">
																				...
																				<p class="mkdf-accordion-title">
																					...
																					<span class="mkdf-tab-title">Legal and law advices</span>
																				</p>
																				<div class="mkdf-accordion-content">
																					<div class="mkdf-accordion-content-inner">
																						<div class="wpb_text_column wpb_content_element ">
									...
									<div class="mkdf-row-grid-section-wrapper mkdf-parallax-row-holder" data-parallax-bg-image=https://anwalt.qodeinteractive.com/wp-content/uploads/2018/03/h2-img-parallax-1.jpg data-parallax-bg-speed=1>
										<div class="mkdf-row-grid-section">
											<div class="vc_row wpb_row vc_row-fluid vc_custom_1522307083648">
														...
														<div class="wpb_wrapper">
															<div class="mkdf-testimonials-holder mkdf-testimonials-standard  clearfix">
																<div class="mkdf-testimonials mkdf-owl-slider" data-number-of-items="1" data-enable-loop="yes" data-enable-autoplay="yes" data-slider-speed="5000" data-slider-speed-animation="600" data-enable-navigation="no" data-enable-pagination="yes">
																	<div class="mkdf-testimonial-content" id="mkdf-testimonials-316">
																		<div class="mkdf-testimonial-text-holder">
																			<h3 itemprop="name" class="mkdf-testimonial-title entry-title">What clients say about us</h3>
																			...
																			<h6 class="mkdf-testimonial-text">
																				...
																				Phasellus viverra nulla ut laoreet.
																				Quisque rutrum natoque.&#039;&#039;
																			</h6>
																			<span class="mkdf-testimonial-author">
																				<span class="mkdf-testimonials-author-name">John Reed</span>
																			</span>
																		</div>
																	</div>
																	<div class="mkdf-testimonial-content" id="mkdf-testimonials-314">
																		<div class="mkdf-testimonial-text-holder">
																			...
																			<span class="mkdf-testimonial-author">
																				<span class="mkdf-testimonials-author-name">Nina Smith</span>
																			</span>
																		</div>
																	</div>
																	<div class="mkdf-testimonial-content" id="mkdf-testimonials-304">
																		<div class="mkdf-testimonial-text-holder">
																			<h3 itemprop="name" class="mkdf-testimonial-title entry-title">
																				What clients say about us
																			</h3>
																			...
																			<h6 class="mkdf-testimonial-text">
																				...
																				ultricies nisi siet est vel augue
																				consectetuer adipiscing elit. Aenean
																				commodo ligula eget.&#039;&#039;
																			</h6>
																			<span class="mkdf-testimonial-author">
																				<span class="mkdf-testimonials-author-name">Jesica Thompson</span>
																			</span>
																		</div>
																	</div>
																</div>
																		...
																		<div class="mkdf-eh-item-content mkdf-eh-custom-2651">
																			<div class="mkdf-progress-bar ">
																				...
																				<div class="mkdf-pb-content-holder">
																					<div data-percentage=93 class="mkdf-pb-content" style="background-color: #aa9166">
																					</div>
																				</div>
																			</div>
																			...
																			<div class="mkdf-progress-bar ">
																				...
																				<div class="mkdf-pb-content-holder">
																					<div data-percentage=56 class="mkdf-pb-content" style="background-color: #aa9166">
																					</div>
																				</div>
																			</div>
																			<div class="vc_empty_space" style="height: 32px"><span class="vc_empty_space_inner"></span>
																			...
																			<div class="mkdf-progress-bar ">
																				...
																				<div class="mkdf-pb-content-holder">
																					<div data-percentage=77 class="mkdf-pb-content" style="background-color: #aa9166">
																					</div>
																				</div>
																			</div>
																			<div class="vc_empty_space" style="height: 32px"><span class="vc_empty_space_inner"></span>
																			...
																			<div class="mkdf-progress-bar ">
																				...
																				<div class="mkdf-pb-content-holder">
																					<div data-percentage=85 class="mkdf-pb-content" style="background-color: #aa9166">
																					</div>
																				</div>
																			</div>
																		</div>
																...
																<div class="mkdf-cc-inner mkdf-owl-slider" data-number-of-items="5" data-enable-loop="yes" data-enable-autoplay="yes" data-slider-speed="5000" data-slider-speed-animation="600" data-enable-navigation="no" data-enable-pagination="no" data-number-of-rows="1">
																	<div class="mkdf-cc-item">
																		<a itemprop="url" class="mkdf-cc-link mkdf-block-drag-link" href="#" target="_self">
																			<img itemprop="image" class="mkdf-cc-image" src="assets/wp-content/uploads/2018/04/h2-client-img-1.png" alt="i" />
																			<img itemprop="image" class="mkdf-cc-hover-image" src="assets/wp-content/uploads/2018/04/h2-client-img-1.png" alt="i" />
																		</a>
																	</div>
																	<div class="mkdf-cc-item">
																		<a itemprop="url" class="mkdf-cc-link mkdf-block-drag-link" href="#" target="_self">
																			<img itemprop="image" class="mkdf-cc-image" src="assets/wp-content/uploads/2018/04/h2-client-img-2.png" alt="i" />
																			<img itemprop="image" class="mkdf-cc-hover-image" src="assets/wp-content/uploads/2018/04/h2-client-img-2.png" alt="i" />
																		</a>
																	</div>
																	<div class="mkdf-cc-item">
																		<a itemprop="url" class="mkdf-cc-link mkdf-block-drag-link" href="#" target="_self">
																			<img itemprop="image" class="mkdf-cc-image" src="assets/wp-content/uploads/2018/04/h2-client-img-3.png" alt="i" />
																			<img itemprop="image" class="mkdf-cc-hover-image" src="assets/wp-content/uploads/2018/04/h2-client-img-3.png" alt="i" />
																		</a>
																	</div>
																	<div class="mkdf-cc-item">
																		<a itemprop="url" class="mkdf-cc-link mkdf-block-drag-link" href="#" target="_self">
																			<img itemprop="image" class="mkdf-cc-image" src="assets/wp-content/uploads/2018/04/h2-client-img-4.png" alt="i" />
																			<img itemprop="image" class="mkdf-cc-hover-image" src="assets/wp-content/uploads/2018/04/h2-client-img-4.png" alt="i" />
																		</a>
																	</div>
																	<div class="mkdf-cc-item">
																		<a itemprop="url" class="mkdf-cc-link mkdf-block-drag-link" href="#" target="_self">
																			<img itemprop="image" class="mkdf-cc-image" src="assets/wp-content/uploads/2018/04/h2-client-img-5.png" alt="i" />
																			<img itemprop="image" class="mkdf-cc-hover-image" src="assets/wp-content/uploads/2018/04/h2-client-img-5.png" alt="i" />
																		</a>
																	</div>
																</div>
															</div>
