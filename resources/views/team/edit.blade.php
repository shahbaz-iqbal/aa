							...
							<div class="border border-3 p-4 rounded">
								<form action="{{url('/admin/team_update')}}" method="POST" enctype="multipart/form-data">
									...
									<div class="mb-3">
										...
										<input type="text" class="form-control" name="title" id="inputProductTitle" placeholder="Enter title" value="{{$team->title}}">
									</div>
									<div class="mb-3">
										<label for="inputProductTitle" class="form-label"> Designation</label>
										<input type="text" class="form-control" name="designation" id="inputProductTitle" placeholder="Enter Designation" value="{{$team->designation}}">
									</div>
									<div class="mb-3">
										<label for="inputProductTitle" class="form-label"> Description</label>
										<input class="form-control" name="description" type="text" placeholder="Enter Description" value="{{$team->description}}">
									</div>
