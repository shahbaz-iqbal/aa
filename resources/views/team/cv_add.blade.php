                    ...
                    <div class="row">
                        <div class="col-lg-10">
                            <div class="border border-3 p-4 rounded">
                                <form action="{{url('/admin/upload_cv_post')}}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <div class="input-group mb-3">
                                        <input type="hidden" name="old_file" value="<?php if ($cv->pdf) {
                                                                                        echo $cv->pdf;
                                                                                    }  ?>">
                                        <input type="hidden" name="old_file_cvf" value="<?php if ($cv->cvf) {
                                                                                        echo $cv->cvf;
                                                                                    }  ?>">
                                        <input type="hidden" name="id" value="<?php if ($cv->id) {
                                                                                        echo $cv->id;
                                                                                    }  ?>">
