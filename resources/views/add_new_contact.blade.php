							...
							<div class="border border-3 p-4 rounded">
								<form action="">
									<div class="mb-3">
										...
										<input type="text" class="form-control" id="inputProductTitle" placeholder="Enter Country Name">
									</div>
									<div class="mb-3">
										<label for="inputProductTitle" class="form-label">Complete Address</label>
										<input type="text" class="form-control" id="inputProductTitle" placeholder="Enter Complete Address">
									</div>

									<div class="mb-3">
										<label for="inputProductTitle" class="form-label">Nearest Tube/Station</label>
										<input type="text" class="form-control" id="inputProductTitle" placeholder="Enter Nearest Tube/Station">
									</div>

									<div class="mb-3">
										<label for="inputProductTitle" class="form-label"> Telephone</label>
										<input type="text" class="form-control" id="inputProductTitle" placeholder="Enter Telephone">
									</div>

									<div class="mb-3">
										<label for="inputProductTitle" class="form-label"> Fax</label>
										<input type="text" class="form-control" id="inputProductTitle" placeholder="Enter Fax">
									</div>
									<div class="mb-3">
										<label for="inputProductTitle" class="form-label"> Email</label>
										<input type="email" class="form-control" id="inputProductTitle" placeholder="Enter Email">
									</div>
