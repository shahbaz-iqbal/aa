						...
						<div class="card">
							<div class="card-body">
								<div class="border p-4 rounded">
									...
									<!-- <form class="row g-3" method="POST" action="{{url('/logout')}}">
									@csrf
									<button type="submit" class="btn btn-light"><i class="bx bxs-lock-open"></i>Sign out</button>
									</form> -->
									<div class="form-body">
										<form class="row g-3" method="POST" action="{{url('/login')}}">
											...
											<div class="col-12">
												...
												<div class="input-group" id="show_hide_password">
													<input type="text" class="form-control border-end-0" name="password" id="inputChoosePassword" placeholder="Enter Password">
