							...
							<div class="border border-3 p-4 rounded">
								<form action="">
									...
									<div class="mb-3">
										...
										<textarea class="form-control" id="inputProductDescription" rows="3" placeholder="Enter Subtitle"></textarea>
									</div>
									<!-- <div class="mb-3">
										<label for="inputProductDescription" class="form-label">Background Image</label>
										<input id="c" type="file" accept=".xlsx,.xls,image/*,.doc,audio/*,.docx,video/*,.ppt,.pptx,.txt,.pdf" multiple>
									</div> -->
